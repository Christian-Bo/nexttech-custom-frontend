...
const MODULES = [
  ...
  { to: '/login', icon: 'mdi-badge-account-horizontal-outline', title: 'Login único', text: 'Compradores y personal usan la misma pantalla; cada quien llega a su tienda o panel según su rol.' },
